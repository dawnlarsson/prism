...
![License](https://img.shields.io/badge/license-Apache_2.0-blue) ![Language](https://img.shields.io/badge/language-C-lightgrey) ![Tests](https://img.shields.io/badge/tests-3902_passing-brightgreen) ![Zero deps](https://img.shields.io/badge/dependencies-0-brightgreen)
...
- **3902 tests** — edge cases, control flow, nightmares, trying hard to break Prism
