...
// Test 20: Multiple variables of typedef type (now supported!)
void test_multiple_vars_typedef(void)
{
    MyInt a, b, c; // Multi-declarator now works!
    CHECK(a == 0 && b == 0 && c == 0, "multiple vars of typedef (auto zero-init)");
}
