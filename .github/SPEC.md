...
**Version:** 1.1.4
**Status:** Implemented — every item in this document corresponds to behavior that exists in the codebase and is exercised by the test suite (6008 tests, self-host stage1==stage2, zero failures).
