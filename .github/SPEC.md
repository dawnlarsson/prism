...
**Version:** 1.0.2
**Status:** Implemented — every item in this document corresponds to behavior that exists in the codebase and is exercised by the test suite (3994+ tests + self-host stage1==stage2).
