...
Note: Prism is thoroughly empirically tested (self-hosting and 4650+ test cases) but **is not formally verified.** It is designed to compile standard-compliant code, but **may not catch every obscure constraint violation** defined by the ISO C standard.
