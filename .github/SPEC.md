...
**Version:** 1.0.8
**Status:** Implemented — every item in this document corresponds to behavior that exists in the codebase and is exercised by the test suite (4859+ tests + self-host stage1==stage2).
...
Note: Prism is thoroughly empirically tested (self-hosting and 4859+ test cases) but **is not formally verified.** It is designed to compile standard-compliant code, but **may not catch every obscure constraint violation** defined by the ISO C standard.
