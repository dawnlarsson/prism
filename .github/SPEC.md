...
**Version:** 1.1.5
**Status:** Implemented — every item in this document corresponds to behavior that exists in the codebase and is exercised by the test suite (6,998+ tests in `prism run .github/test.c`, self-host stage1==stage2 in CI, zero failures — on both release and `PRISM_DEBUG` builds).
